...
export const workProjects: WorkProject[] = [
  {
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/rCY0UI7DADE?si=uhjO-9GepSD9lp-n" },
      { name: "Letterboxd", link: "https://letterboxd.com/film/chet-larson/" },
      { name: "Rateyourmusic", link: "https://rateyourmusic.com/film/chet-larson/" },
      { name: "IMDB", link: "https://www.imdb.com/title/tt31960957/" },
      { name: "Trailer", link: "https://youtu.be/tEatKWZEHjg?si=jkPaNg4RBuOrdUWW" }
    ],
    quotes: [
    ...
    groupings: [
      { name: "Luke", group: ["Directing", "Writing", "Editing", "Cinematography"] },
      { name: "Noah", group: ["Directing", "Producing", "Writing", "Editing", "Acting"] }
    ]
  },
  {
    id: 2,
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/pJZMi_rg00g?si=LOaxcGby5rirDYhx" },
      { name: "Letterboxd", link: "https://letterboxd.com/film/chet-larson-coda/" },
      { name: "Rateyourmusic", link: "https://rateyourmusic.com/film/chet-larson-2/" }
    ],
    groupings: [
      { name: "Luke", group: ["Directing", "Writing", "Editing", "Cinematography"] },
      { name: "Noah", group: ["Directing", "Producing", "Writing", "Editing", "Acting"] }
  ...
  },
  {
    ...
    lukeWork: true,
    noahWork: true,
    description: "After running into her ex with her new girlfriend at a convenience store they used to frequent, Mindy finds herself trapped in a continuous time loop.",
    genre: ["Drama", "Romance"],
    releaseYear: 2024,
    cast: [
    ...
    crew: [
      ...
      { name: "Samuel Correa", role: ["Director of Photography", "Color Grading"] },
      { name: "Jaden Garcia", role: ["Key Grip"] },
      { name: "Jalen Rayno", role: ["Production Sound Engineer", "Sound Design"] },
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/FBVMGRyXjCE?si=wCmET54VQlbmdnc6" },
      { name: "Letterboxd", link: "https://letterboxd.com/film/convenience-2024/" },
  ...
  {
    id: 4,
    image: ["/images/moviePosters/victorianBoy.jpg", "/images/victorianBoy/screenshot.png"],
    title: "The Small Victorian Boy",
    description: "In post Civil War West Virginia, 9 year old Little Jamie has his life forever changed when he unexpectedly meets his Uncle Vernon, who tells him that both his parents died only two nights ago. However, not all is as it seems with this strange man.",
    ...
    crew: [
      ...
      { name: "Sebastian Mann", role: ["Key Grip", "Production Sound Engineers"] },
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/fSvC047OZB4?si=GrBVTShMqOvG_dQN" },
      { name: "Letterboxd", link: "https://letterboxd.com/film/the-small-victorian-boy/" },
      { name: "Rateyourmusic", link: "https://rateyourmusic.com/film/the-small-victorian-boy/" },
      { name: "IMDB", link: "https://www.imdb.com/title/tt33998394/?ref_=nm_knf_t_1" },
      { name: "Trailer 1", link: "https://www.instagram.com/p/DCkB3kRR-E7/" },
      { name: "Trailer 2", link: "https://www.instagram.com/p/DCkB3kRR-E7/" }
    ],
    groupings: [
      { name: "Luke", group: ["Directing", "Producing", "Writing", "Editing", "Acting"] },
      { name: "Noah", group: ["Directing", "Producing", "Writing", "Editing", "Cinematography"] }
    ]
  },
  {
    id: 5,
    ...
    description: "In this short parody of classic American soap operas, Williamson discovers that his wife is having an affair with their pastor.",
    lukeWork: true,
    noahWork: true,
    ...
    crew: [
      ...
      { name: "India Soodoo", role: ["Director of Photography", "Lighting", "Sound Mixing"] },
      { name: "Jimmy Albert", role: ["Lighting", "Studio Supervisors", "Stage Supervisors"] },
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/M0TAiDSJjsE?si=Sfu5Kr3U9WyZdjf1" }
    ],
    groupings: [
      { name: "Luke", group: ["Directing", "Producing", "Writing", "Editing"] },
      { name: "Noah", group: ["Directing", "Writing", "Editing"] }
  ...
  },
  {
    ...
    crew: [
      ...
      { name: "Luke Clarke", role: ["Producer"] },
      { name: "Amulya Chalapathy", role: ["Producer", "Pre-Production Coordinator", "Camera Operators"] },
      { name: "Sarvani Eleswarapu", role: ["Pre-Production Coordinator", "Camera Operators"] },
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/NfIOq610rSo?si=88NQleOMxMZS07HW" },
      { name: "Trailer", link: "https://www.instagram.com/reel/C7fNtJ2P21H/" }
    ],
    groupings: [
      { name: "Luke", group: ["Directing", "Producing", "Editing", "Cinematography", "Music Video"] },
  ...
  },
  {
    ...
    description: "In the first ever music video for the Energy Solution, wealthy musician and entrepreneur Sam lives a life of wealth and decadence. However, loneliness and isolation plague the Washington DC native deep in the heart of Pittsburgh.",
    lukeWork: true,
    noahWork: true,
    genre: ["Music Video", "Electronic"],
    releaseYear: 2025,
    cast: [
      { name: "Samuel Ingram", character: "" }
    ],
    crew: [
      { name: "Luke & Noah Clarke", role: ["Director", "Editor", "Cinematographer"] },
      { name: "Luke Clarke", role: ["Producer"] },
      { name: "Noah Clarke", role: ["Producer"] },
    ...
    links: [
      { name: "Youtube", link: "https://www.youtube.com/watch?v=eW3gz6-foxY&ab_channel=TheEnergySolution" },
      { name: "Trailer", link: "https://www.instagram.com/p/DI14RG-xreY/" }
    ],
    groupings: [
      { name: "Luke", group: ["Directing", "Producing", "Editing", "Cinematography", "Music Video"] },
      { name: "Noah", group: ["Directing", "Producing", "Editing", "Cinematography", "Music Video"] }
    ]
  },
  {
    id: 8,
  ...
  {
    id: 9,
    image: ["/images/wvfs2024/nabihahCover.jpeg","/images/wvfs2024/nabihah.jpeg"],
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/PHD26y4FzKY?si=XO7vo59QefGcnFtV" },
      { name: "Instagram Ad", link: "https://www.instagram.com/p/DA9YNsTTGsT/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" }
    ],
    groupings: [
  ...
  {
    id: 10,
    image: ["/images/wvfs2024/ellieBleachCover.png","/images/wvfs2024/ellieBleach.jpeg"],
    title: "Ellie Bleach Interview | WVFS at SXSW 2024",
    description: "In the third interview conducted by the staff of the WVFS radio station at the 2024 SXSW festival in Austin Texas, interviewer Arman Rezaian talks with British singer and songwriter Ellie Bleach. This interview was shot by Luke, who edited this installment alongside Noah.",
    genre: ["Interview"],
    releaseYear: 2024,
    cast: [
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/tNfOeDrN8RI?si=GN82oPrCaH6oYSjL" },
      { name: "Instagram Ad", link: "https://www.instagram.com/p/C_1BdEPSFWp/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Cinematography", "Editing", "Documentary"] },
      { name: "Noah", group: ["Producing", "Editing", "Documentary"] }
    ]
  },
  {
    ...
    description: "In the second interview conducted by the staff of the WVFS radio station at the 2024 SXSW festival in Austin Texas, interviewer Casey Chapter talks with Nashville singer and songwriter Mali Velasquez along with band members Jarrod Gee and Maddy Young. This interview was shot by Luke, who edited this installment alongside Noah.",
    genre: ["Interview"],
    releaseYear: 2024,
    cast: [
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/JzDk4MkXuu4?si=mrhanFL8WiBZst0P" },
      { name: "Instagram Ad", link: "https://www.instagram.com/p/C_glO65SSlW/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Cinematography", "Editing", "Documentary"] },
      { name: "Noah", group: ["Producing", "Editing", "Documentary"] }
  ...
  },
  {
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/HC2sfEHVE-U?si=wt9Bz6FvHhBU3nFz" },
      { name: "Instagram ad", link: "https://www.instagram.com/p/C9IeuMLuV0D/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Cinematography", "Editing", "Documentary"] },
      { name: "Noah", group: ["Producing", "Editing", "Documentary"] }
  ...
  },
  {
    ...
    description: "This news featurette, written by reporter Kailey Schuchts, highlights FSU's campus tours programs, designed to show off the college to incoming students.",
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/XD8iid7oFDk?si=2UbcVBmh94Wjn9cr" }
    ],
    groupings: [
  ...
  },
  {
    ...
    description: "This news featurette, written by reporter Kaitlyn Walsh, highlights FSU's mentor program to help assist incoming transfer students.",
    genre: ["News Featurette"],
    releaseYear: 2023,
    cast: [],
    crew: [
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/m_wgR5POErM?si=uaWabSSewS1XUyTS" }
    ],
    groupings: [
  ...
  },
  {
    ...
    description: "This news featurette written by reporter Maddy Branning highlights FSU's club softball program.",
    genre: ["News Featurette"],
    releaseYear: 2023,
    cast: [],
    crew: [
      { name: "Luke Clarke", role: ["Director", "Producer", "Editor"] },
      { name: "Gabriel Curtis", role: ["Director", "Producer", "Editor", "Director of Photography"] },
      { name: "Maddy Branning", role: ["Writer", "Reporter"] }
    ],
    links: [
      { name: "Youtube", link: "https://youtu.be/Tz9oBflSkkc?si=f3oIs1W8kDc88veU" }
    ],
    groupings: [
  ...
  },
  {
    ...
    description: "This short news featurette highlights the South of Soho art gallery in Tallahassee, Florida.",
    genre: ["News Featurette"],
    releaseYear: 2023,
    cast: [],
    crew: [
      { name: "Luke Clarke", role: ["Producer", "Editor", "Director of Photography"] },
      { name: "Christian Summersill", role: ["Director of Photography", "Editor"] }
    ],
    links: [
  ...
  },
  {
    ...
    description: "This short news featurette highlights the Florida State University Marching band known as the Marching Chiefs.",
    genre: ["News Featurette"],
    releaseYear: 2024,
    cast: [],
    crew: [
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/YYEZO-EVRUM?si=I2Wew95VGf379X9w" }
    ],
    groupings: [
  ...
  },
  {
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/sQLuCec7Fqo?si=UulCmL-UTvU8VRn2" }
    ],
    groupings: [
      { name: "Noah", group: ["Producing", "Editing", "Cinematography"] }
    ]
  },
  {
    ...
    description: "For the 10 year anniversary of our first ever short film, Gramps: The Movie (made at the age of 12), we decided to record a video commentary track in which we watch the short film 7 times in a row. As the commentary track goes on, our thoughts on the movie become more and more particular and irrational.",
    genre: ["Reaction Video"],
    releaseYear: 2024,
    cast: [
      { name: "Luke & Noah Clarke", character: "Starring" }
    ],
    crew: [
      { name: "Luke & Noah Clarke", role: ["Editor"] }
    ],
    links: [
      { name: "Youtube", link: "https://youtu.be/rs9yS0W6NLs?si=5NO3V65c_SvAR-0V" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing", "Documentary"] },
      { name: "Noah", group: ["Producing", "Editing", "Documentary"] }
  ...
  },
  {
    ...
    description: "During the livestream premiere of Chet Larson, an introductory skit, written and directed by Luke & Noah and featuring popular recording artist Quinn, was included before the movie itself. This short shows a stage interaction between Quinn and the fictionalized Chet and Ernie characters.",
  ...
  },
  {
    ...
    description: "This news feature compiles several shorter, news featurettes into one complete episode of news from FSU in the spring of 2024. These news featurettes are brought together by sections filmed with Sarah Grace Hutchinson.",
    genre: ["News Feature"],
    releaseYear: 2024,
    cast: [
      { name: "Sarah Grace Hutchinson", character: "Show Host" }
    ],
    crew: [
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/DDBvj73K1FI?si=GjCMotcZElOohT_r" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing"] }
    ]
  },
  {
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/wz4dkEWw9QI?si=SanGmepsVuO5f7eg" }
    ],
    groupings: [
      { name: "Luke", group: ["Acting"] }
    ]
  },
  {
    id: 23,
    ...
    description: "In this 2023 black and white dramedy short by writer and director Kane Bumpers, we follow a mime going about their lonely, day to day tasks. In the film, Luke plays a thief who steals what little money the mime makes busking.",
    genre: ["Drama", "Comedy"],
    releaseYear: 2023,
    cast: [
    ...
    crew: [
      { name: "Kane Bumpers", role: ["Writer", "Director", "Editor", "Cinematography", "Sound Design"] },
      { name: "Sam Boyer", role: ["Gaffer"] },
      { name: "Sara Gonzalez", role: ["Lighting Technician"] }
    ],
    links: [
      { name: "Youtube", link: "https://youtu.be/NdQt2LJwoz4?si=sgyROYCmrJjuBWBl" }
    ],
    groupings: [
      { name: "Luke", group: ["Acting"] }
    ]
  },
  {
    ...
    crew: [
      ...
      { name: "Isabela de la Grana", role: ["Director of Photography", "Editor"] },
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/kzYM4O359_g?si=MstHv-ZrINmsQdXY" }
    ],
    groupings: [
      { name: "Noah", group: ["Acting"] }
    ]
  },
  {
    id: 25,
    ...
    description: "In this 2023 black and white dramedy short by writer and director Tommy Adzema, Noah plays Ian alongside Sara Gonzalez as Lucy.",
    genre: ["Drama"],
    noahWork: true,
    releaseYear: 2023,
    cast: [
    ...
    crew: [
      ...
      { name: "Jalen Rayno", role: ["First Assistant Camera", "Grip & Electric"] },
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/-b4cW_N0l70?si=R_Ui77UG6C_8BoKU" }
    ],
    groupings: [
      { name: "Noah", group: ["Acting"] }
    ]
  },
  {
    ...
    description: "In this 2023 horror comedy short by director Chris J. Lopez, Luke is mistaken for a serial killer, or is he?",
    genre: ["Comedy", "Horror"],
    releaseYear: 2023,
    cast: [
    ...
    crew: [
      { name: "Chris J. Lopez", role: ["Writer", "Director", "Editor", "Music"] },
      { name: "Sean Denney", role: ["Director of Photography"] }
    ],
    links: [
      { name: "Youtube", link: "https://youtu.be/VDSDr50GNKY?si=oH6WE-M8MWIzaVKZ" }
    ],
    groupings: [
      { name: "Luke", group: ["Acting"] }
    ]
  },
  {
    ...
    description: "This experimental short film from director Samuel Correa (who would go on to be the director of photography on Convenience) sees Noah acting as the roommate to future collaborator Jaden Garcia.",
    ...
    crew: [
      { name: "Samuel Correa", role: ["Director", "Cinematographer"] }
    ],
    links: [
      { name: "Youtube", link: "https://youtu.be/f_ASjhGXifA?si=7eDSGvwwgR6lLia5" }
    ],
    groupings: [
      { name: "Noah", group: ["Acting"] }
    ]
  },
  {
    ...
    description: "In this recording of the Spring 2024 Stitch Fashion Runway, Luke acted as one of four camera operators tasked with recording the event. On top of this, Luke assisted in the construction and breakdown of equipment for this show at the direction of close collaborator Jay Rayno.",
    ...
    links: [
      { name: "Youtube", link: "https://youtu.be/NNTxKOtRJGo?si=IEDyDx_-tYWLEvxf" }
    ],
    groupings: [
      { name: "Luke", group: ["Cinematography"] }
    ]
  },
  {
    id: 29,
    ...
    description: "Luke was the set director and primary sound coordinator on a season's worth of episodes of The Seminole Scoop, a weekly, social media based, news show for the FSView & Florida Flambeau. Luke would also occasionally assist in editing, color grading, and general direction.",
    genre: ["Weekly news show"],
    releaseYear: 2024,
    cast: [
      { name: "Benjamin Taubman", character: "Host" }
    ],
    crew: [
    ...
    links: [
      { name: "Instagram 1", link: "https://www.instagram.com/fsview/reel/C3D6ntVr5OS/" },
      { name: "Instagram 2", link: "https://www.instagram.com/fsview/reel/C3YzsvLL_JU/" },
      { name: "Instagram 3", link: "https://www.instagram.com/fsview/reel/C3neagwLo-D/" },
      { name: "Instagram 4", link: "https://www.instagram.com/fsview/reel/C33gA2-rocR/" },
      { name: "Instagram 5", link: "https://www.instagram.com/fsview/reel/C4MZSVhLNne/" },
      { name: "Instagram 6", link: "https://www.instagram.com/fsview/reel/C4tnv7ZLuLG/" },
      { name: "Instagram 7", link: "https://www.instagram.com/fsview/reel/C4_Cm5urNjD/" },
      { name: "Instagram 8", link: "https://www.instagram.com/fsview/reel/C5PHYK_rszt/" },
      { name: "Instagram 9", link: "https://www.instagram.com/fsview/reel/C5lmbA7rb5A/" },
      { name: "Instagram 10", link: "https://www.instagram.com/fsview/reel/C51hDVMu2x3/" },
      { name: "Instagram 11", link: "https://www.instagram.com/fsview/reel/C6JyvKvLh36/" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing", "Documentary"] }
    ]
  },
  {
    ...
    description: "A photoshoot for the DMV based, post-hardcore/shoegaze band \"Toro\" at a Portuguese restaurant located in Wheaton, Maryland. These decadent photos were taken in support of their then recently released single \"Latin Kobe\"",
    genre: ["Photography"],
    releaseYear: 2025,
    cast: [],
    crew: [],
    links: [
      { name: "Instagram", link: "https://www.instagram.com/p/DLGejUsRbzR/?img_index=1" },
      { name: "Linkedin", link: "https://www.linkedin.com/feed/update/urn:li:activity:7355206388966453250/" }
    ],
    groupings: [
  ...
  },
  {
    ...
    title: "Mountains",
    description: "An abstract portrayal of mountains created, shot, and edited by Luke",
    lukeWork: true,
    ...
    crew: [],
    links: [
      { name: "Instagram", link: "https://www.instagram.com/p/DGi_dhbRwZ2/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" }
    ],
    groupings: [
      { name: "Luke", group: ["Photography"] }
    ]
  },
  {
    ...
    description: "Cover Art, CD design, and general art direction for the release of the Ambient Electronic EP Artifice by Virginia based musician Perky. The art was designed to reflect the seasonal themes and soothing tones of the works 4 songs.",
    lukeWork: true,
    noahWork: true,
    ...
    crew: [],
    links: [
      { name: "Luke's Instagram Post", link: "https://www.instagram.com/p/DKAcBANxHlW/?img_index=1" },
      { name: "Noah's Instagram Post", link: "https://www.instagram.com/p/DKF-d11RY0w/?img_index=1" }
    ],
    groupings: [
  ...
  },
  {
    ...
    description: "Behind the scenes photos taken during the filming of Jalen Rayno's short film Roadside",
    genre: ["Photography"],
    releaseYear: 2024,
    cast: [],
    crew: [],
  ...
  },
  {
    ...
    links: [
      { name: "Bandcamp", link: "https://roxyphantom.bandcamp.com/album/so-much" },
      { name: "Spotify", link: "https://open.spotify.com/album/1sA11z4tmIMqF1MlSigHoN?si=_0MFZx1aQAGe_yO5tqCq6A" },
      { name: "Rateyourmusic", link: "https://rateyourmusic.com/release/album/roxy-phantom/so-much/" }
    ],
    groupings: [
  ...
  },
  {
    ...
    image: [],
    title: "MAIZE5 DJ Mix",
    description: "To mark the 5 year anniversary of their now defunct mashup channel Maize Music, Luke & Noah released their third DJ Mix, MAIZE5. Compiling the best mashups the two had constructed over the preceding half decade, this journey through popular recorded music is a perfect send off to this era of their work.",
    genre: ["Plunderphonics", "Mashup", "Comedy"],
    releaseYear: 2022,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/8YCHZt_fvW8?si=cNVEvnCfT0IZmddz" },
      { name: "Soundcloud", link: "https://soundcloud.com/maize-music/maize5" },
      { name: "Rateyourmusic", link: "https://rateyourmusic.com/release/djmix/maize-music/maize5/" }
    ],
    groupings: [
      { name: "Luke", group: ["Music"] },
      { name: "Noah", group: ["Music"] }
  ...
  },
  {
    ...
    description: "In promotion of the film Chet Larson, outsider house artist DJ Sabrina the Teenage DJ helped curate the officially released soundtrack for the film. Made up of 6 previously released tracks from her discography, this EP's songs were both sequenced and re-edited by Luke & Noah to make for a breezy, 32 minute listen.",
    genre: ["House", "Plunderphonics", "Dance-pop", "Outsider House", "Nu Disco"],
    releaseYear: 2021,
    cast: [],
    crew: [],
    links: [
      { name: "Spotify", link: "https://open.spotify.com/album/0RrGvAD0uRywqUNoZCILCB?si=5MNAjwW1QjyoMpVMZIGSUg" },
      { name: "Apple Music", link: "https://music.apple.com/us/album/chet-larson-original-motion-picture-soundtrack-ep/1588324301" },
      { name: "Tidal", link: "https://tidal.com/browse/album/199544011" },
      { name: "Genius", link: "https://genius.com/albums/Dj-sabrina-the-teenage-dj/Chet-larson-original-motion-picture-soundtrack" },
      { name: "Rateyourmusic", link: "https://rateyourmusic.com/release/ep/dj-sabrina-the-teenage-dj/chet-larson/" },
  ...
  },
  {
    ...
    description: "Luke and Noah's second DJ Mix in only a month, this body of work finds the pair expanding upon the sounds explored in their first. More firmly cementing a chopped and screwed and dream pop sound, Songs That Don't Get the Crowd Goin manages to stand alone as a well curated collection of distorted samples that never sacrifices the comedic spirit of its predecessor.",
    genre: ["Plunderphonics", "Mashup", "Chopped & Screwed"],
    releaseYear: 2021,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/VGmhaUlVwk0?si=QuRpjJDvCe92LEAL" },
      { name: "Soundcloud", link: "https://on.soundcloud.com/zvCKeS4pUG5HyFRH1C" },
      { name: "Rateyourmusic", link: "https://rateyourmusic.com/release/djmix/songs-that-dont-get-the-crowd-goin/songs-that-dont-get-the-crowd-goin/" }
    ],
    groupings: [
      { name: "Luke", group: ["Music"] },
      { name: "Noah", group: ["Music"] }
  ...
  },
  {
    ...
    description: "During the Covid-19 Pandemic, Luke and Noah unveiled their debut DJ Mix to the unsuspecting crowd of Bangerfest 2's virtual concert goers across the globe. This absurd 25 minute mashup of popular recorded music with original songs is a perfect time capsule of a culture in lockdown",
    genre: ["Plunderphonics", "Mashup", "Comedy"],
    releaseYear: 2021,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/sL9xs9mqIhM?si=BgYtzJS958G0F-ye" },
      { name: "Soundcloud", link: "https://on.soundcloud.com/W9YiwFu1C4kH47x8VF" },
      { name: "Rateyourmusic", link: "https://rateyourmusic.com/release/djmix/_vuestela-affiliates-luke-and-noah-clarke-present-songs-that-get-the-crowd-goin-a-dj-mix-by-maize-music-hosted-by-ig-philbin-sponsored-by-ben-and-jerrys-chetlarsoncomingsoon/_vuestela-affiliates-luke-and-noah-clarke-present-%E2%80%9Csongs-that-get-the-crowd-goin%E2%80%9D-a-dj-mix-by-maize-music-hosted-by-ig-philbin-sponsored-by-ben-and-jerry%E2%80%99s-chetlarsoncomingsoon/" }
    ],
    groupings: [
      { name: "Luke", group: ["Music"] },
      { name: "Noah", group: ["Music"] }
  ...
  },
  {
    ...
    description: "Episode 1 of a three part series produced and edited by Luke & Noah that finds their high school teachers attempting to play Minecraft with one another on school computers.",
    genre: ["Let's Play", "Reaction Video"],
    releaseYear: 2019,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/EFj5xkfwyiA?si=1xnkTmeYCUMB5-AD" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing"] },
  ...
  },
  {
    ...
    description: "Episode 2 of a three part series produced and edited by Luke & Noah that finds their high school teachers attempting to play Minecraft with one another on school computers.",
    genre: ["Let's Play", "Reaction Video"],
    releaseYear: 2020,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/tylOd67C3ls?si=AfISM0VFyk16ChrX" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing"] },
      { name: "Noah", group: ["Producing", "Editing"] }
  ...
  },
  {
    ...
    description: "The final episode of a three part series produced and edited by Luke & Noah that finds their high school teachers attempting to play Minecraft with one another on school computers.",
    genre: ["Let's Play", "Reaction Video"],
    releaseYear: 2020,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/gtuDdYze0uo?si=ev4pn1ObHL7UVHEN" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing"] },
      { name: "Noah", group: ["Producing", "Editing"] }
  ...
  },
  {
    ...
    description: "The first episode of a series produced and edited by Luke and Noah chronicling Quince Orchard High School's day care students. This episode focuses on the \"graduating class\" of 2019.",
    genre: ["Interview", "News Featurette", "Comedy"],
    releaseYear: 2019,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/JE3cymBDgVk?si=gy2Ga5KBRcMIes4L" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing", "Documentary"] },
      { name: "Noah", group: ["Producing", "Editing", "Documentary"] }
  ...
  },
  {
    ...
    description: "The second episode of a series produced and edited by Luke and Noah chronicling Quince Orchard High School's day care students. This episode, which initially premiered as a part of QOTV's weekly news show, follows Quince Orchard's daycare students as they participate in Halloween themed activities.",
    genre: ["Interview", "News Featurette", "Comedy"],
    releaseYear: 2019,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/3Wok_xY8QJQ?si=f7QTVt9TKWljUtQn" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing", "Documentary"] },
      { name: "Noah", group: ["Producing", "Editing", "Documentary"] }
  ...
  },
  {
    ...
    description: "The third episode of a series produced and edited by Luke and Noah chronicling Quince Orchard High School's day care students. This episode, which initially premiered as a part of QOTV's weekly news show, follows Quince Orchard's daycare students as they participate in Thanksgiving themed activities.",
    genre: ["Interview", "News Featurette", "Comedy"],
    releaseYear: 2019,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/5Qjr0z-zAXw?si=BD7aQIbfDSgrRl5S" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing", "Documentary"] },
      { name: "Noah", group: ["Producing", "Editing", "Documentary"] }
  ...
  },
  {
    ...
    description: "The fourth episode of a series produced and edited by Luke and Noah chronicling Quince Orchard High School's day care students. This episode, which initially premiered as a part of QOTV's weekly news show, follows Quince Orchard's daycare students as they participate in Christmas and Winter themed activities.",
    genre: ["Interview", "News Featurette", "Comedy"],
    releaseYear: 2020,
    cast: [],
    crew: [],
    links: [
      { name: "Youtube", link: "https://youtu.be/dVtAxK0pxGM?si=AzP8gudVrPxQ_nj3" }
    ],
    groupings: [
      { name: "Luke", group: ["Producing", "Editing", "Documentary"] },
      { name: "Noah", group: ["Producing", "Editing", "Documentary"] }
